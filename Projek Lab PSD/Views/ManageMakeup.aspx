...
<asp:Content ID="Content1" ContentPlaceHolderID="content" runat="server">
    ...
    <div>
        ...
        <asp:GridView ID="MakeupGrid" runat="server" AutoGenerateColumns="false" OnRowDeleting="MakeupGrid_RowDeleting" OnRowEditing="MakeupGrid_RowEditing">
            <Columns>
    ...
    <div>
        ...
        <asp:GridView ID="MakeupTypeGrid" runat="server" AutoGenerateColumns="False" OnRowDeleting="MakeupTypeGrid_RowDeleting" OnRowEditing="MakeupTypeGrid_RowEditing">
            <Columns>
    ...
    <div>
        ...
        <asp:GridView ID="MakeupBrandGrid" runat="server" AutoGenerateColumns="False" OnRowDeleting="MakeupBrandGrid_RowDeleting" OnRowEditing="MakeupBrandGrid_RowEditing">
            <Columns>
    ...
    <asp:Button ID="InsertMakeupBtn" runat="server" Text="Insert Makeup" onClick="InsertPageBtn_Click"/>
    <asp:Button ID="InsertMakeupTypeBtn" runat="server" Text="Insert Makeup Type" OnClick="InsertMakeupTypeBtn_Click" />
    <asp:Button ID="InsertMakeupBrandBtn" runat="server" Text="Insert Brand Type" OnClick="InsertMakeupBrandBtn_Click"/>
</asp:Content>
